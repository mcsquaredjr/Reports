...
$pyjs['loaded_modules']['pyjamas.ui.FormPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('getTextContents', function(iframe) {
			...
			var $pyjs_try_err;
			try {
				if ($p['bool'](!$p['bool']($p['getattr'](iframe, 'contentDocument')))) {
					return null;
				}
	...
	, 1, [null,null,['self'],['form'],['event'],['something']]);
		...
		$method = $pyjs__bind_method2('hookEvents', function(iframe, form, listener) {
			...
			if ($p['bool']((iframe !== null))) {
				$assign1 = (typeof get_main_frame == "undefined"?$m['get_main_frame']:get_main_frame)();
				wf = $assign1;
				mf = $assign1;
				self['_onload_listener'] = mf['addEventListener'](iframe, 'load', $p['getattr'](self, '_onload'));
			}
			self['_onsubmit_listener'] = mf['addEventListener'](form, 'onsubmit', $p['getattr'](self, '_onsubmit'));
			return null;
		}
	...
	, 1, [null,null,['self'],['target']]);
		...
		$method = $pyjs__bind_method2('unhookEvents', function(iframe, form) {
			...
			iframe['removeEventListener']('load', $p['getattr'](self, '_onload_listener'), true);
			form['removeEventListener']('onsubmit', $p['getattr'](self, '_onsubmit_listener'), true);
			return null;
		}
