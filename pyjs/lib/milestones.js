...
$pyjs['loaded_modules']['milestones'] = function (__mod_name__) {
	...
	$m['Milestones_Editor'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self['hpanel'] = $pyjs_kwargs_call(null, $m['HorizontalPanel'], null, null, [{'Width':'735px'}]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('load', function() {
			...
			self['data']['append']($p['list']([0, 'Milestone1', 'Active', '20/09/2013', '30/09/2013']));
			self['data']['append']($p['list']([1, 'Milestone2', 'Inactive', '20/09/2013', '30/09/2013']));
			self['data']['append']($p['list']([2, 'Milestone3', 'Inactive', '20/09/2013', '30/09/2013']));
			self['data_deleted']['append']($p['list']([3, 'Milestone4', 'Deleted', '20/09/2013', '30/09/2013']));
			self['data_deleted']['append']($p['list']([4, 'Milestone5', 'Deleted', '20/09/2013', '30/09/2013']));
			self['data_deleted']['append']($p['list']([5, 'Milestone6', 'Deleted', '20/09/2013', '30/09/2013']));
	...
	, 1, [null,null]);
		...
		$method = $pyjs__bind_method2('add_row', function(new_data) {
			...
			var $iter3_idx,$iter4_idx,el,$iter4_nextval,$iter3_array,milestone_name,exist,$iter3_iter,$iter4_type,$iter3_type,$iter4_array,$iter4_iter,$iter3_nextval;
			...
			if ($p['bool'](!$p['bool'](exist))) {
				self['data']['append']($p['list']([null, milestone_name, new_data['__getitem__'](1), new_data['__getitem__'](2), new_data['__getitem__'](3), $m['NOT_EXIST_IN_DB_STATUS']]));
			}
			return !$p['bool'](exist);
		}
	, 1, [null,null,['self'],['new_data']]);
		...
		$method = $pyjs__bind_method2('remove_row', function(row) {
			...
			if ($p['bool']($p['op_eq'](row_data['__getitem__'](5), $m['EXIST_IN_DB_STATUS']))) {
	...
	, 1, [null,null,['self'],['model'],['view']]);
		...
		$method = $pyjs__bind_method2('process_msg', function(msg) {
			...
			var new_data,cal_id,row_data,grid,editor,data,row;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onModuleLoad', function() {
			...
			self['tbl_panel'] = $pyjs_kwargs_call(null, $m['VerticalPanel'], null, null, [{'Width':'735px'}]);
