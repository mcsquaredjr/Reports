...
$pyjs['loaded_modules']['milestones'] = function (__mod_name__) {
	...
	$m['Milestones_Editor'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self['start']['appendValidListener']($m['display_ok']);
			self['start']['appendInvalidListener']($m['display_error']);
			...
			self['end']['appendValidListener']($m['display_ok']);
			self['end']['appendInvalidListener']($m['display_error']);
